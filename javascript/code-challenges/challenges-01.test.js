...
Use `forEach` to loop over the input array and work with each value.  Push the new value into a local array.
...
Write a function named `addExclamation` that takes an array of strings, and returns a new array 
