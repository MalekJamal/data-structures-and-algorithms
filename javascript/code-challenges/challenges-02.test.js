...
array and returns a new array. The returned array should contain the result 
...
const evenOdd = (arr) => {
  ...
  arr.map(num=>{
    if(typeof(num) ===typeof(2)){
      num%2==0 ?arr2.push("even"):arr2.push("odd")
    }else{
      arr2.push("N/A");
    }
  });
